...
export const ReceiptSchema = zod.object({
    ...
    contract: zod.string().min(1, "Vui lòng chọn hợp đồng khách hàng trước khi thu"),
...
export type ReceiptSchemaType = zod.infer<typeof ReceiptSchema>;